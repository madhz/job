        ...
        <table class="table table-condensed">
            ...
            <tbody id="tbody_filter">
                ...
                <?php //made changes ?>
                    ...
                    @endif
                    <td>
                     @if($job->cnt_pending_review< 1 && $job->active_in_interview_phase< 1 && $job->candidates_not_considered < 1 && $job->candidates_rejected<1 && $job->withdraw_job_submission<1 && $job->candidate_success<1)
