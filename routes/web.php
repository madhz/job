...
Route::get('paywithpaypal', array('as' => 'paypalpayment.paywithpaypal','uses' => 'PaypalPaymentController@paywithpaypal',));
Route::post('paypal', array('as' => 'paypalpayment.paypal','uses' => 'PaypalPaymentController@postPaymentWithpaypal',));
Route::get('paypal', array('as' => 'payment.status','uses' => 'PaypalPaymentController@getPaymentStatus',));
// Route::get('payWithPaypal',function(){

//     return "jksdfksdjfsjf";
// });
// Route::get('payPremium/{paymentremain}', ['as'=>'payPremium','uses'=>'AddMoneyController@payPremium']);
